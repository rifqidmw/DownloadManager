...
data class DownloadedFile(
    ...
    val statusText: String
        get() {
            when (status) {
                DownloadManager.STATUS_FAILED -> return "STATUS_FAILED $status"
                DownloadManager.STATUS_PAUSED -> return "STATUS_PAUSED $status"
                DownloadManager.STATUS_PENDING -> return "STATUS_PENDING $status"
                DownloadManager.STATUS_RUNNING -> return "STATUS_RUNNING $status"
                DownloadManager.STATUS_SUCCESSFUL -> return "STATUS_SUCCESSFUL $status"
